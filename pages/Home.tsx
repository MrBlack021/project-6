...
const TechLogo: React.FC<{ name: string, path: string }> = ({ name, path }) => (
  <div className="flex items-center justify-center p-3 bg-light-bg-main dark:bg-dark-bg-secondary rounded-lg border border-light-border dark:border-dark-border" title={name}>
    <svg className="h-8 text-primary" fill="currentColor" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><title>{name}</title><path d={path}/></svg>
  </div>
);
            ...
            <FadeIn>
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="relative w-full h-80 md:h-full rounded-lg overflow-hidden border border-light-border dark:border-dark-border">
                         <img
                            src="https://images.unsplash.com/photo-1677756119517-756a188d2d94?auto=format&fit=crop&w=1740&q=80"
            ...
            <FadeIn>
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    <div className="relative w-full h-80 md:h-full rounded-lg overflow-hidden border border-light-border dark:border-dark-border order-2 md:order-1">
                         <img
                            src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1740&q=80"
                            alt="A professional business pitch presentation"
                            className="w-full h-full object-cover"
                        />
                    </div>
            ...
            <FadeIn>
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-12">
                     <MentorCard 
                        ...
                        imageUrl="https://ui-avatars.com/api/?name=Siraz+S&background=007AFF&color=FFFFFF&size=128&bold=true"
                    />
                    <MentorCard 
                        name="Nagaraju K"
                        title="Founder & CEO, InnovateU"
                        imageUrl="https://ui-avatars.com/api/?name=Nagaraju+K&background=007AFF&color=FFFFFF&size=128&bold=true"
                    />
                    <MentorCard 
                        name="D Venkatesh"
                        title="Venture Partner, GrowthCap"
                        imageUrl="https://ui-avatars.com/api/?name=D+Venkatesh&background=007AFF&color=FFFFFF&size=128&bold=true"
                    />
                </div>
            </FadeIn>
        </div>
